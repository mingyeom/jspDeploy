...
public class PicDownloadServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.setHeader("Content-Disposition", "attacjment; filename=\"" + studentVo.getPic() + "\"");
		response.setContentType("application/octet-stream");
		
		//FileUtil.fileUploadPath : moon.png
		//파라미터로 파일명 제공
		// localhost:8180/fileDownload?fileName=moon.png
