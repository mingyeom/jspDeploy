...
//1kb = 1024
//1MB = 1kb * 1000
//5MB = 1MG * 5 == 1KB * 1000 * 5 = 1024 * 1000 * 5
...
public class FileUploadServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (uploadFilePart.getSize() > 0) {
			...
			//사용자가 업로드한 실제 파일명은 디비상에 저장하고, 물리적 파일은 임의로 적용
			uploadFilePart.write(path + File.separator + UUID.randomUUID().toString());
			//path : D:\A_TeachingMaterial\7.JspSpring\workspace\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps
			//fileName : moon.png
